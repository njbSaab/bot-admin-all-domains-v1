...
export class EmailTemplateThird {
  ...
  templateImage1: string = 'https://i.ibb.co/cKjwF54R/let-bg-body.png';
  templateImage2: string = 'https://i.ibb.co/My9h6JB9/1xbet-logo.png';
  templateImage3: string = '';
...
<div dir="ltr" class="es-wrapper-color">
                  ...
                  <table width="600" cellspacing="0" cellpadding="0" align="center" class="es-content-body" style="background-color: transparent">
                    <tbody>
                      ...
                      <tr class="footer-display">
                        <td align="left" class="esd-structure es-p15t es-p30b es-p25r es-p25l">
                          <table cellpadding="0" cellspacing="0" align="left"  width="100%" class="es-left ">
                            <tbody>
                              <tr>
                                <td align="left" class="es-m-p20b esd-container-frame footer-content">
                                  <table cellpadding="0" cellspacing="0" width="100%">
                                    <tbody>
                                      <tr>
                                        <td align="center" class="es-content-body">
  ...
  resetTemplate(): void {
    ...
    this.templateButtonLink = '';
    this.templateImage1 = '';
    this.templateImage2 = '';
    this.templateFooterText =
    'If you do not wish to receive emails from us, please write to this address 1111@gmail.com.';
  }
}