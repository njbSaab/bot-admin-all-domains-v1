export const environment = {
  ...
  auth: {
    ...
    // baseUrl: 'https://kr.devsmm.pro',
    // apiUrlEventLandings: 'https://forecast-server-kr.najib-saab.workers.dev/1xarea-admin/landings',
    // apiUrlEvents: 'https://forecast-server-kr.najib-saab.workers.dev/1xarea-admin/events',
